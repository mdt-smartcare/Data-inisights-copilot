...
class ConfigService:
    ...
    def generate_draft_prompt(self, data_dictionary: str) -> Dict[str, Any]:
        ...
        instruction = (
            ...
            "4. **CRITICAL**: Include instructions for automatic chart generation. The AI must generate chart visualizations when returning numerical or categorical data. "
            "Add a section like:\\n\\n"
            "**CHART GENERATION RULES:**\\n"
            "For ANY query that returns categorical or numerical data suitable for visualization (counts, distributions, comparisons, breakdowns, KPIs), "
            "you MUST include a JSON block at the end of your response with chart data in this format:\\n\\n"
            "```json\\n"
            "{{\\n"
            "    \\\"chart_json\\\": {{\\n"
            "        \\\"title\\\": \\\"Descriptive Chart Title\\\",\\n"
            "        \\\"type\\\": \\\"pie|bar|line|scorecard|radar|treemap\\\",\\n"
            "        \\\"data\\\": {{\\n"
            "            \\\"labels\\\": [\\\"Category1\\\", \\\"Category2\\\"],\\n"
            "            \\\"values\\\": [100, 200]\\n"
            "        }},\\n"
            "        \\\"metrics\\\": [  // ONLY for type 'scorecard'\\n"
            "           {{ \\\"label\\\": \\\"Total Revenue\\\", \\\"value\\\": \\\"$1.2M\\\", \\\"change\\\": \\\"+5.2%\\\", \\\"status\\\": \\\"up\\\" }},\\n"
            "           {{ \\\"label\\\": \\\"Active Cases\\\", \\\"value\\\": 1540, \\\"change\\\": \\\"-2.1%\\\", \\\"status\\\": \\\"down\\\" }}\\n"
            "        ]\\n"
            "    }}\\n"
            "}}\\n"
            "```\\n\\n"
